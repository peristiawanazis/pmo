...
// default start Time : first working hour
if ($task_id == 0)
	$start_date->setTime($start,0,0);
...
?>
		<select id="day_type" name="day_type" class="text">
			<option value="0"><?php echo $AppUI->_('Worked days'); ?></option>
			<option value="1"><?php echo $AppUI->_('Calendar days'); ?></option>
		</select>
	</td>
