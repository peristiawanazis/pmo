...
if ($canReadProject) {
	...
	$titleBlock->addBreadcrumb("?m=projects&amp;a=view&amp;project_id=$obj->task_project", @$obj->project_name, '../modules/projects/images/applet3-48.png');
	$titleBlock->addCrumb('?m=tasks', 'tasks list');
}else $titleBlock->addBreadcrumb('?m=tasks', 'Tasks');

$titleBlock->addBreadcrumb('',@$obj->task_name, 'applet-48.png');
if ($canEdit) {
...
smartUpdateProjectPercentComplete($obj->task_project);
?>
	...
	<td width="50%">
		...
		<tr>
			<td nowrap="nowrap" colspan="2">
				<?php if ($canEdit) { ?>
					<a href="?m=tasks&amp;a=addedit&amp;task_id=<?php echo $task_id; ?>"><img src="images/icons/pencil.gif" title="<?php echo $AppUI->_("edit this task"); ?>"/>
					</a>
				<?php } ?>
				<strong> <?php echo $AppUI->_('Details');?></strong></td>
		</tr>
		<tr>
