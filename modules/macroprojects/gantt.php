...
$macroprojectStatus = arrayMerge(array('-2' => $AppUI->_('All w/o in progress'), 
                                  '-3' => $AppUI->_(($AppUI->user_id == $user_id) 
                                                    ? 'My macroprojects' : "User's macroprojects")), 
                            $macroprojectStatus);
...
} else if ($macroproFilter == '-3') {
	$q->addWhere('macroproject_owner = ' . $user_id);
} else if ($macroproFilter == '-2') {
	$q->addWhere('macroproject_status != 3');
} else if ($macroproFilter != '-1') {
	$q->addWhere('macroproject_status = ' . $macroproFilter);
}
