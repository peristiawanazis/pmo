<?php /* MACRO_PROJECTS vw_idx_active.php, v 0.1.0 2012/05/30 */
/*
...
foreach ($macroprojects as $row) {
	...
	// We don't check the percent_completed == 100 because some macroprojects
	// were being categorized as completed but not all the tasks had been created (for new macroprojects)
	if ($row['macroproject_status'] == 3) {
		$none = false;
