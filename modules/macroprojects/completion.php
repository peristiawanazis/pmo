...
$(document).ready(function(){
		...
		for(i=0;i<projects.length;i++){
		  ...
		  s2[i] = parseInt(projects[x].p_completed_toactive);
		  s3[i] = parseInt(projects[x].p_completed);
		  s4[i] = parseInt(tasks[x].p_completed);
        ...
        plot1 = $.jqplot('chart1', [s2], {
			...
			title: {
				text : 'Completion Rate by Projects',
				show : true,
				fontSize : 16,
			},
...
<table >
<tr></tr><td><u>Completion Rate</u> menggambarkan diagram prosentase dari setiap kategori Project dan Task yang critical </td></tr>
<tr></tr><td>yang harus diselsaikan secara cepat </td></tr>
</table>
</div>
