...
?>
	<tr>
		...
		<?php if ($macroproject_id == 0) { ?>
			<td><a href="?m=macroprojects&amp;a=view&amp;macroproject_id=<?php echo $log['macroproject_id']; ?>"><?php echo $log['macroproject_name'] ?></a></td>
		<?php } ?>
		<td>
...
<?php
	...
	// make the PDF file
		if ($macroproject_id != 0) {
			...
			$q->addWhere(makeWhereClauseEachProjectOfAMacroProject($macroproject_id, 'project_id ='));
			$pname = $q->loadResult();
		} else {
			$pname = "All Projects";
		}
