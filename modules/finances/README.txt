FINANCES MODULE
 	...
 	finances dotproject module : TODO

	Copyright (C) 2012 Région Poitou-Charentes (France)
						Simon BENUREAU <simon.benureau@gmail.com>

	The dotProject software is distributed under the GNU/GPL licence
	The jQuery library is distributed under MIT licence
...
INSTALLATION
	...
	The finances module is designed for dP v2.1.5, tests have not been made for other versions.
