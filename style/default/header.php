...
<tr>
	...
	<th align="right" width='50'><a href='http://www.dotproject.net/' <?php if ($dialog) echo "target='_blank'"; ?>><img src="style/<?php echo $uistyle;?>/images/ipc_login.gif" border="0" alt="http://dotproject.net/" /></a></th>
	</tr></table></td>
</tr>
<?php if (!$dialog) {
	// top navigation menu
