...
echo $uistyle;?>/images/logo_ipc.png" type="image/ico" /> <!-- favicon.ico-->
...
<tr>
	<td><table width='100%' cellpadding="3" cellspacing="0" border="0"><tr>
		<h1 style="position: absolute; top: 14px; font-size: 22px; color: #2815D1;">Directorat Operasi</h1></th>
...
echo $uistyle;?>/images/ipc_login.png" style="height: 60px; width: 100px; " border="0" /></a></th> <!-- dp_icon.gif-->
